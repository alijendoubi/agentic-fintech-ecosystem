...
pub enum SensoryError {
    ...
    // Boxed: tungstenite's error is >130 bytes and would bloat every Result.
...
impl From<tokio_tungstenite::tungstenite::Error> for SensoryError {
    fn from(e: tokio_tungstenite::tungstenite::Error) -> Self {
        SensoryError::WebSocket(Box::new(e))
    }
}
